...
assertIncludes(careBoard, "이번 주 놓치지 않을 안부와 기도제목", "leader care board");
...
assertIncludes(careBoard, "리더에게 공개된 내용만 모아", "leader care board privacy trust");
assertIncludes(careBoard, "이름 숨김 제목은 작성자를 드러내지 않아요", "leader care board privacy trust");
...
assertIncludes(careBoard, "함께 기억할 기도", "leader care board");
...
assertIncludes(careBoard, "이전 기도제목 더 보기", "leader care board scalable prayer list");
assertIncludes(careBoard, "bg-white/80", "leader care board lighter surface");
assertIncludes(careBoard, "shadow-[0_10px_30px_rgba(31,41,51,0.06)]", "leader care board softer surface shadow");
